...
1. Explain the difference between `Relational Databases` and `SQL`.
   sql databases are arranged in tables and all entries have the same fields, and relational databases are arranged by relational algorithims and each entry can have any fields they need

2. Why do tables need a `primary key`?
   to identify each item and to use as reference in queries or other tables
